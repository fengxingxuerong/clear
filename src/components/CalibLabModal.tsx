    ...
    <div className="modal-mask" onClick={onClose}>
      ...
      >
          ...
          {st.bestWeight !== null && (
            <>
              ...
              <button
                className="ghost sm"
                style={{ marginLeft: 8 }}
                onClick={() => onApplyWeight(st.bestWeight as number)}
              >
                应用为默认
              </button>
            </>
        ...
        {ordered.map((s) => (
          ...
          >
            ...
            {s.official !== null ? (
              <span
                className="tag"
                style={{ color: "var(--accent2)", borderColor: "rgba(61,220,151,0.5)" }}
              >
                官方 {s.official}%（
                {s.officialLabel === "ai"
                  ? "AI生成"
                  : s.officialLabel === "suspected"
                    ? "疑似AI辅助"
                    : "人工特征"}
                ）
              </span>
            ...
            <button className="ghost sm" onClick={() => onCopy(s.text)}>
              复制
            </button>
            {s.official === null && (
              <button
            ...
            <button className="ghost sm" onClick={() => onDelete(s.id)}>
              删
            </button>
          </div>
        ))}
        ...
        <div className="modal-actions">
          <button className="ghost sm" onClick={onClear}>
            清空样本库
          </button>
