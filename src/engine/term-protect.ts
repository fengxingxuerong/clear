...
const BUILT_IN_TERMS = new Set<string>([
  // 法学
  "善意取得", "无因管理", "不当得利", "表见代理", "缔约过失", "罪刑法定",
  "正当防卫", "紧急避险", "诉讼时效", "举证责任", "物权变动", "公示公信",
  // 经济/金融
  "边际效应", "机会成本", "通货膨胀", "量化宽松", "供需关系", "规模经济",
  "基尼系数", "恩格尔系数", "国内生产总值", "消费者物价指数",
  // 医学
  "细胞凋亡", "免疫应答", "血脑屏障", "基因表达", "临床试验", "随机对照",
  "不良反应", "禁忌症", "适应性免疫", "获得性免疫",
  // 理工/计算机
  "机器学习", "深度学习", "神经网络", "强化学习", "联邦学习", "边缘计算",
  "量子纠缠", "基因编辑", "碳中和", "碳达峰", "光刻机", "芯片制程",
  "操作系统", "分布式系统", "容错机制", "负载均衡", "数据挖掘",
  // 教育/社科
  "因材施教", "立德树人", "核心素养", "产教融合", "终身学习",
  "城镇化率", "基期", "同比", "环比",
]);
